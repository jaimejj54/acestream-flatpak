...
static const char *ICON_NAME_OVERRIDE = "org.Acestream.engine-symbolic";

/* Copied from Spotify (https://github.com/flathub/com.spotify.Client/blob/master/spotify-preload.c) */
